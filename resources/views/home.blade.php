...
<div class="container">
    <div class="py-5 text-center">
        <img class="d-block mx-auto mb-4 rounded-circle placeholder" src="" alt="" height="100"  width="100"/>
        <h1 class="display-5 fw-bold text-body-emphasis">Welcome back, name</h1>
